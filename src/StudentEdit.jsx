...
function StudentEdit() {
  ...
  const formik = useFormik({
      ...
      onSubmit: async (values) => {
          let student = await axios.post(`https://63770e2081a568fc250af1f6.mockapi.io/student${params.id}`)
...
let loadUser = async () => {
    try {
      let user =  await axios.get(`https://63770e2081a568fc250af1f6.mockapi.io/student${params.id}`)
   formik.setValues({
